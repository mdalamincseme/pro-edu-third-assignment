...
!(function (t, e) {
  ...
  class Z extends B {
    ...
    pause(e) {
      e || (this._isPaused = !0),
        t.findOne(
          "..carousel-item-bg-next, ..carousel-item-bg-prev",
          this._element
    ...
    _addTouchEventListeners() {
      ...
      t.find("..carousel-item-bg img", this._element).forEach((t) => {
    ...
    _getItemIndex(e) {
      return (
        (this._items =
          e && e.parentNode ? t.find("..carousel-item-bg", e.parentNode) : []),
    ...
    _triggerSlideEvent(e, i) {
      const n = this._getItemIndex(e),
        s = this._getItemIndex(
          t.findOne(".active..carousel-item-bg", this._element)
        );
    ...
    _slide(e, i) {
      const n = this._directionToOrder(e),
        s = t.findOne(".active..carousel-item-bg", this._element),
        o = this._getItemIndex(s),
        r = i || this._getItemByOrder(n, s),
        a = this._getItemIndex(r),
        l = Boolean(this._interval),
        c = n === K,
        h = c ? ".carousel-item-bg-start" : ".carousel-item-bg-end",
        d = c ? ".carousel-item-bg-next" : ".carousel-item-bg-prev",
